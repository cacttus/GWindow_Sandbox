#pragma once
#ifndef __ASYNC_SCENE_TEST_2023098572387_H__
#define __ASYNC_SCENE_TEST_2023098572387_H__
/*
  This is commented out but it's still valid for future implementation.
  Objective of GWindow_Sandbox
    Vulkan Windows
    Scenes update independently of rendering.
      Perform unlimited updates.
      Render scene.
    Window families share the same scene.
      Window Family = sharing same context.
